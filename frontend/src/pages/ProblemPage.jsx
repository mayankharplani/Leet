...
const ProblemPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-base-200 to-base-100 max-w-7xl w-full">
      <nav className="navbar bg-base-100 shadow-lg px-4 text-white">
            ...
            <div className="card-body p-0">
              ...
              <div className="p-4 border-t border-base-300 bg-base-200">
                <div className="flex justify-between items-center">
                  ...
                  <button className="btn btn-success gap-2">Submit</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <>
              ...
              <div className="overflow-x-auto">
                <table className="table w-full">
                  <thead>
                    <tr>
                      <th className="text-black">Input</th>
                      <th className="text-black">Expected Output</th>
                    </tr>
                  </thead>
                  <tbody>
